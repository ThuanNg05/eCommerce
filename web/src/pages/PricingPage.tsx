...
const RATE_CARD_FIELDS: { key: keyof UpdateRateCardRequest; label: string; unit: string }[] = [
  { key: 'prKieng', label: 'Kính', unit: 'VND / m²' },
  { key: 'prNhL', label: 'Nhôm lớn', unit: 'VND / m' },
  { key: 'prNhN', label: 'Nhôm nhỏ', unit: 'VND / m' },
  { key: 'prGL', label: 'Gỗ lớn', unit: 'VND / m' },
  { key: 'prGN', label: 'Gỗ nhỏ', unit: 'VND / m' },
  { key: 'prDL', label: 'Đen lớn', unit: 'VND / m' },
  { key: 'prBack', label: 'Ván hậu', unit: 'VND / m²' },
  { key: 'prLua', label: 'Lụa', unit: 'VND / m²' },
  { key: 'prKT', label: 'Kim tuyến', unit: 'VND / m²' },
  { key: 'prOc', label: 'Ốc', unit: 'VND / cái' },
  { key: 'prNhom', label: 'Khung nhôm', unit: 'VND / m' },
  { key: 'pr7F', label: '7 Phân', unit: 'VND / m' },
  { key: 'pr2D', label: '2D', unit: 'VND / m²' },
  { key: 'prDecal', label: 'Decal', unit: 'VND / m²' },
]
              ...
              <>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <Typography variant="caption" sx={{ color: '#a3a3a3' }}>
                    Cập nhật gần nhất: {formatDate(rateCardData?.updatedAt)}
                  </Typography>
